...
export const file_entities_node: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_protobuf_struct, file_entities_user, file_entities_group, file_entities_flow]);
...
export type Node = Message<"process.Node"> & {
   ...
   *
   * @generated from field: int32 width = 34;
   */
  width: number;

  /**
   * @generated from field: int32 height = 35;
   */
  height: number;

  /**
   * @generated from field: bool is_expanded = 36;
   */
  isExpanded: boolean;
