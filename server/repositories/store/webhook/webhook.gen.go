...
func (q *Query) cursor(col uint32, r Row) {
	...
	case 9:
		...
		q.strs[q.ns] = r.CorrelationExpression.V
		q.ns++
	case 10:
...
// NullTextCol addresses a varchar(512) column.
...
func (q Query) TokenEq(v string) Query                 { return q.Where(Token.Eq(v)) }
func (q Query) TokenNotEq(v string) Query              { return q.Where(Token.NotEq(v)) }
func (q Query) TokenGt(v string) Query                 { return q.Where(Token.Gt(v)) }
func (q Query) TokenGte(v string) Query                { return q.Where(Token.Gte(v)) }
func (q Query) TokenLt(v string) Query                 { return q.Where(Token.Lt(v)) }
func (q Query) TokenLte(v string) Query                { return q.Where(Token.Lte(v)) }
func (q Query) TokenLike(v string) Query               { return q.Where(Token.Like(v)) }
func (q Query) TokenILike(v string) Query              { return q.Where(Token.ILike(v)) }
func (q Query) TokenIn(v ...string) Query              { return q.Where(Token.In(v...)) }
func (q Query) TokenNotIn(v ...string) Query           { return q.Where(Token.NotIn(v...)) }
func (q Query) SecretEq(v string) Query                { return q.Where(Secret.Eq(v)) }
func (q Query) SecretNotEq(v string) Query             { return q.Where(Secret.NotEq(v)) }
func (q Query) SecretGt(v string) Query                { return q.Where(Secret.Gt(v)) }
func (q Query) SecretGte(v string) Query               { return q.Where(Secret.Gte(v)) }
func (q Query) SecretLt(v string) Query                { return q.Where(Secret.Lt(v)) }
func (q Query) SecretLte(v string) Query               { return q.Where(Secret.Lte(v)) }
func (q Query) SecretLike(v string) Query              { return q.Where(Secret.Like(v)) }
func (q Query) SecretILike(v string) Query             { return q.Where(Secret.ILike(v)) }
func (q Query) SecretIn(v ...string) Query             { return q.Where(Secret.In(v...)) }
func (q Query) SecretNotIn(v ...string) Query          { return q.Where(Secret.NotIn(v...)) }
func (q Query) SignatureHeaderEq(v string) Query       { return q.Where(SignatureHeader.Eq(v)) }
func (q Query) SignatureHeaderNotEq(v string) Query    { return q.Where(SignatureHeader.NotEq(v)) }
func (q Query) SignatureHeaderGt(v string) Query       { return q.Where(SignatureHeader.Gt(v)) }
func (q Query) SignatureHeaderGte(v string) Query      { return q.Where(SignatureHeader.Gte(v)) }
func (q Query) SignatureHeaderLt(v string) Query       { return q.Where(SignatureHeader.Lt(v)) }
func (q Query) SignatureHeaderLte(v string) Query      { return q.Where(SignatureHeader.Lte(v)) }
func (q Query) SignatureHeaderLike(v string) Query     { return q.Where(SignatureHeader.Like(v)) }
func (q Query) SignatureHeaderILike(v string) Query    { return q.Where(SignatureHeader.ILike(v)) }
func (q Query) SignatureHeaderIn(v ...string) Query    { return q.Where(SignatureHeader.In(v...)) }
func (q Query) SignatureHeaderNotIn(v ...string) Query { return q.Where(SignatureHeader.NotIn(v...)) }
func (q Query) MessageNameEq(v string) Query           { return q.Where(MessageName.Eq(v)) }
func (q Query) MessageNameNotEq(v string) Query        { return q.Where(MessageName.NotEq(v)) }
func (q Query) MessageNameGt(v string) Query           { return q.Where(MessageName.Gt(v)) }
func (q Query) MessageNameGte(v string) Query          { return q.Where(MessageName.Gte(v)) }
func (q Query) MessageNameLt(v string) Query           { return q.Where(MessageName.Lt(v)) }
func (q Query) MessageNameLte(v string) Query          { return q.Where(MessageName.Lte(v)) }
func (q Query) MessageNameLike(v string) Query         { return q.Where(MessageName.Like(v)) }
func (q Query) MessageNameILike(v string) Query        { return q.Where(MessageName.ILike(v)) }
func (q Query) MessageNameIn(v ...string) Query        { return q.Where(MessageName.In(v...)) }
func (q Query) MessageNameNotIn(v ...string) Query     { return q.Where(MessageName.NotIn(v...)) }
func (q Query) CorrelationExpressionEq(v string) Query { return q.Where(CorrelationExpression.Eq(v)) }
func (q Query) CorrelationExpressionNotEq(v string) Query {
	return q.Where(CorrelationExpression.NotEq(v))
}
func (q Query) CorrelationExpressionGt(v string) Query  { return q.Where(CorrelationExpression.Gt(v)) }
func (q Query) CorrelationExpressionGte(v string) Query { return q.Where(CorrelationExpression.Gte(v)) }
func (q Query) CorrelationExpressionLt(v string) Query  { return q.Where(CorrelationExpression.Lt(v)) }
func (q Query) CorrelationExpressionLte(v string) Query { return q.Where(CorrelationExpression.Lte(v)) }
func (q Query) CorrelationExpressionLike(v string) Query {
	return q.Where(CorrelationExpression.Like(v))
}
func (q Query) CorrelationExpressionILike(v string) Query {
	return q.Where(CorrelationExpression.ILike(v))
}
func (q Query) CorrelationExpressionIn(v ...string) Query {
	return q.Where(CorrelationExpression.In(v...))
}
func (q Query) CorrelationExpressionNotIn(v ...string) Query {
	return q.Where(CorrelationExpression.NotIn(v...))
}
func (q Query) CorrelationExpressionIsNull() Query { return q.Where(CorrelationExpression.IsNull()) }
...
var orderTable = [nCols][4]string{
	...
	{ // signature_header
		"\"signature_header\"",
		"\"signature_header\" DESC",
		"\"signature_header\" ASC NULLS FIRST",
		"\"signature_header\" DESC NULLS LAST",
	},
	{ // message_name
		"\"message_name\"",
		"\"message_name\" DESC",
		"\"message_name\" ASC NULLS FIRST",
		"\"message_name\" DESC NULLS LAST",
	},
	{ // correlation_expression
		"\"correlation_expression\"",
		"\"correlation_expression\" DESC",
		"\"correlation_expression\" ASC NULLS FIRST",
		"\"correlation_expression\" DESC NULLS LAST",
	},
	{ // enabled
		"\"enabled\"",
		"\"enabled\" DESC",
...
var fragTable = [12][27]runtime.Frag{
	...
	{ // signature_header
		{}, // opNone
		{A: "\"signature_header\" = $", B: ""},
		{A: "\"signature_header\" <> $", B: ""},
		{A: "\"signature_header\" > $", B: ""},
		{A: "\"signature_header\" >= $", B: ""},
		{A: "\"signature_header\" < $", B: ""},
		{A: "\"signature_header\" <= $", B: ""},
		{A: "\"signature_header\" LIKE $", B: ""},
		{A: "\"signature_header\" ILIKE $", B: ""},
		{},
		{},
		{},
		{},
		{},
		{A: "\"signature_header\" = ANY($", B: ")"},
		{A: "\"signature_header\" <> ALL($", B: ")"},
		{},
		{},
		{},
		{},
	...
	{ // message_name
		...
		{A: "\"message_name\" < $", B: ""},
		{A: "\"message_name\" <= $", B: ""},
		{A: "\"message_name\" LIKE $", B: ""},
		{A: "\"message_name\" ILIKE $", B: ""},
		{},
		{},
		{},
		{},
		{},
		{A: "\"message_name\" = ANY($", B: ")"},
		{A: "\"message_name\" <> ALL($", B: ")"},
		{},
		{},
		{},
		{},
	...
	{ // correlation_expression
		{}, // opNone
		{A: "\"correlation_expression\" = $", B: ""},
		{A: "\"correlation_expression\" <> $", B: ""},
		{A: "\"correlation_expression\" > $", B: ""},
		{A: "\"correlation_expression\" >= $", B: ""},
		{A: "\"correlation_expression\" < $", B: ""},
		{A: "\"correlation_expression\" <= $", B: ""},
		{A: "\"correlation_expression\" LIKE $", B: ""},
		{A: "\"correlation_expression\" ILIKE $", B: ""},
		{},
		{},
		{},
		{},
		{},
		{A: "\"correlation_expression\" = ANY($", B: ")"},
		{A: "\"correlation_expression\" <> ALL($", B: ")"},
		{},
		{},
		{},
		{},
		...
		{},
		{},
		{A: "\"correlation_expression\" IS NULL", B: ""},
		{A: "\"correlation_expression\" IS NOT NULL", B: ""},
		{},
		{},
	},
	{ // enabled
...
func scan(rv [][]byte, r *Row, sl *runtime.Slab) error {
	...
	r.Name = sl.Str(rv[4])
	r.Token = sl.Str(rv[5])
	r.Secret = sl.Str(rv[6])
	r.SignatureHeader = sl.Str(rv[7])
...
func (m *Mut) SetToken(v string) {
	m.row.Token = v
	m.dirty |= dToken
}

func (m *Mut) SetSecret(v string) {
	m.row.Secret = v
	m.dirty |= dSecret
}

func (m *Mut) SetSignatureHeader(v string) {
	m.row.SignatureHeader = v
	m.dirty |= dSignatureHeader
}

func (m *Mut) SetMessageName(v string) {
	m.row.MessageName = v
	m.dirty |= dMessageName
}

func (m *Mut) SetCorrelationExpression(v string) {
	m.row.CorrelationExpression = runtime.Null[string]{V: v, Valid: true}
	m.dirty |= dCorrelationExpression
}

// SetCorrelationExpressionNull writes SQL NULL. It is a separate method because a
// zero value and an absent value are different facts.
func (m *Mut) SetCorrelationExpressionNull() {
	m.row.CorrelationExpression = runtime.Null[string]{}
	m.dirty |= dCorrelationExpression
}
...
func (n *Ins) SetToken(v string) {
	n.row.Token = v
	n.set |= iToken
}

func (n *Ins) SetSecret(v string) {
	n.row.Secret = v
	n.set |= iSecret
}

func (n *Ins) SetSignatureHeader(v string) {
	n.row.SignatureHeader = v
	n.set |= iSignatureHeader
}

func (n *Ins) SetMessageName(v string) {
	n.row.MessageName = v
	n.set |= iMessageName
}

func (n *Ins) SetCorrelationExpression(v string) {
	n.row.CorrelationExpression = runtime.Null[string]{V: v, Valid: true}
	n.set |= iCorrelationExpression
}

// SetCorrelationExpressionNull writes SQL NULL explicitly, which is not the same as
// leaving the column unset and taking its default.
func (n *Ins) SetCorrelationExpressionNull() {
	n.row.CorrelationExpression = runtime.Null[string]{}
	n.set |= iCorrelationExpression
}
...
func assignable(i uint8, mask uint64) []string {
	...
	case 0:
		...
		if mask&(1<<7) != 0 {
			set = append(set, "signature_header")
		}
		if mask&(1<<8) != 0 {
			set = append(set, "message_name")
		}
		if mask&(1<<9) != 0 {
			set = append(set, "correlation_expression")
		}
		if mask&(1<<10) != 0 {
...
// OnConflictToken upserts on the unique index over (token).
//
// The row that already exists keeps every column this insert did
// not assign. Follow with DoNothing() to leave it untouched
// entirely.
func (n *Ins) OnConflictToken() *Ins {
	n.conflict = 4
	return n
}
...
func (n *Ins) Insert(ctx context.Context, ex runtime.Executor) (Row, error) {
	...
	for i := 0; i < nInsertable; i++ {
		...
		case 5:
			args = append(args, n.row.Token)
		case 6:
			args = append(args, n.row.Secret)
		case 7:
			args = append(args, n.row.SignatureHeader)
		case 8:
			args = append(args, n.row.MessageName)
		case 9:
			args = append(args, n.row.CorrelationExpression.Arg())
		case 10:
...
func Insert(ctx context.Context, ex runtime.Executor, r *Row) error {
	...
	args = append(args, r.Secret)
	args = append(args, r.SignatureHeader)
...
func InsertAll(ctx context.Context, ex runtime.Executor, rows []Row) (int64, error) {
	...
	return ex.CopyFrom(ctx, "webhooks", copyCols, src)
}
...
func (m *Mut) UpdateOp() (runtime.BatchOp, bool) {
	...
	for i := 0; i < nUpdatable; i++ {
		...
		case 3:
			args = append(args, m.row.Token)
		case 4:
			args = append(args, m.row.Secret)
		case 5:
			args = append(args, m.row.SignatureHeader)
		case 6:
			args = append(args, m.row.MessageName)
		case 7:
			args = append(args, m.row.CorrelationExpression.Arg())
		case 8:
...
var softDeleteSQL = runtime.SpliceSections(`UPDATE "webhooks" SET "deleted_at" = now()`, []runtime.Section{
...
var restoreSQL = runtime.SpliceSections(`UPDATE "webhooks" SET "deleted_at" = NULL`, []runtime.Section{
