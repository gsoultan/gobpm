...
func (q Query) OrganizationEq(v string) Query          { return q.Where(Organization.Eq(v)) }
func (q Query) OrganizationNotEq(v string) Query       { return q.Where(Organization.NotEq(v)) }
func (q Query) OrganizationGt(v string) Query          { return q.Where(Organization.Gt(v)) }
func (q Query) OrganizationGte(v string) Query         { return q.Where(Organization.Gte(v)) }
func (q Query) OrganizationLt(v string) Query          { return q.Where(Organization.Lt(v)) }
func (q Query) OrganizationLte(v string) Query         { return q.Where(Organization.Lte(v)) }
func (q Query) OrganizationLike(v string) Query        { return q.Where(Organization.Like(v)) }
func (q Query) OrganizationILike(v string) Query       { return q.Where(Organization.ILike(v)) }
func (q Query) OrganizationIn(v ...string) Query       { return q.Where(Organization.In(v...)) }
func (q Query) OrganizationNotIn(v ...string) Query    { return q.Where(Organization.NotIn(v...)) }
...
var orderTable = [nCols][4]string{
	...
	{ // organization
		"\"organization\"",
		"\"organization\" DESC",
		"\"organization\" ASC NULLS FIRST",
		"\"organization\" DESC NULLS LAST",
	},
	{ // email
		"\"email\"",
		"\"email\" DESC",
...
var fragTable = [12][27]runtime.Frag{
	...
	{ // organization
		...
		{A: "\"organization\" < $", B: ""},
		{A: "\"organization\" <= $", B: ""},
		{A: "\"organization\" LIKE $", B: ""},
		{A: "\"organization\" ILIKE $", B: ""},
		{},
		{},
		{},
		{},
		{},
		{A: "\"organization\" = ANY($", B: ")"},
		{A: "\"organization\" <> ALL($", B: ")"},
		{},
		{},
		{},
		{},
...
func scan(rv [][]byte, r *Row, sl *runtime.Slab) error {
	...
	r.FullName = sl.Str(rv[6])
	r.DisplayName = sl.Str(rv[7])
...
func (m *Mut) SetOrganization(v string) {
	m.row.Organization = v
	m.dirty |= dOrganization
}
...
func (n *Ins) SetOrganization(v string) {
	n.row.Organization = v
	n.set |= iOrganization
}
...
func (n *Ins) Insert(ctx context.Context, ex runtime.Executor) (Row, error) {
	...
	for i := 0; i < nInsertable; i++ {
		...
		case 6:
			args = append(args, n.row.FullName)
		case 7:
			args = append(args, n.row.DisplayName)
		case 8:
			args = append(args, n.row.Organization)
		case 9:
...
func (m *Mut) UpdateOp() (runtime.BatchOp, bool) {
	...
	for i := 0; i < nUpdatable; i++ {
		...
		case 4:
			args = append(args, m.row.FullName)
		case 5:
			args = append(args, m.row.DisplayName)
		case 6:
			args = append(args, m.row.Organization)
		case 7:
...
var softDeleteSQL = runtime.SpliceSections(`UPDATE "users" SET "deleted_at" = now()`, []runtime.Section{
...
var restoreSQL = runtime.SpliceSections(`UPDATE "users" SET "deleted_at" = NULL`, []runtime.Section{
