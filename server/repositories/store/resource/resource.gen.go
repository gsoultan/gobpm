...
const selectPrefix = `SELECT "id", "created_at", "updated_at", "deployment_id", "name", "content", "type", "deleted_at" FROM "resources"`
const countPrefix = `SELECT count(*) FROM "resources"`
const existsPrefix = `SELECT 1 FROM "resources"`
...
func batchTopByDeploymentIDWindowSQL(order []Sort) string {
	...
	sql := runtime.SpliceOrder("SELECT \"id\", \"created_at\", \"updated_at\", \"deployment_id\", \"name\", \"content\", \"type\", \"deleted_at\" FROM (SELECT \"id\", \"created_at\", \"updated_at\", \"deployment_id\", \"name\", \"content\", \"type\", \"deleted_at\", row_number() OVER (PARTITION BY \"deployment_id\"\x00order\x00) AS \"_storm_rn\" FROM \"resources\" WHERE \"deployment_id\" = ANY($1) AND \"deleted_at\" IS NULL) \"_storm_t\" WHERE \"_storm_rn\" <= $2", terms, " ORDER BY ", ", ")
...
const insertSQL = `INSERT INTO "resources" ("id", "created_at", "updated_at", "deployment_id", "name", "content", "type", "deleted_at") VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING "id", "created_at", "updated_at", "deployment_id", "name", "content", "type", "deleted_at"`

const updatePrefix = `UPDATE "resources" SET `
const deletePrefix = `DELETE FROM "resources"`
...
const insPrefix = "INSERT INTO \"resources\""
...
func InsertAll(ctx context.Context, ex runtime.Executor, rows []Row) (int64, error) {
	...
	return ex.CopyFrom(ctx, "resources", copyCols, src)
}
...
var softDeleteSQL = runtime.SpliceSections(`UPDATE "resources" SET "deleted_at" = now()`, []runtime.Section{
...
var restoreSQL = runtime.SpliceSections(`UPDATE "resources" SET "deleted_at" = NULL`, []runtime.Section{
