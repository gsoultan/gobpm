...
func HasResources() Pred   { return Pred{col: 6, op: opExists} }
func HasNoResources() Pred { return Pred{col: 6, op: opNotExists} }
...
const selectPrefix = `SELECT "id", "created_at", "updated_at", "project_id", "name", "deleted_at" FROM "deployments"`
const countPrefix = `SELECT count(*) FROM "deployments"`
const existsPrefix = `SELECT 1 FROM "deployments"`
...
var fragTable = [7][27]runtime.Frag{
	...
	{ // relation Resources (pseudo-column)
		{}, // opNone
		{},
		{},
		{},
...
const insertSQL = `INSERT INTO "deployments" ("id", "created_at", "updated_at", "project_id", "name", "deleted_at") VALUES ($1, $2, $3, $4, $5, $6) RETURNING "id", "created_at", "updated_at", "project_id", "name", "deleted_at"`

const updatePrefix = `UPDATE "deployments" SET `
const deletePrefix = `DELETE FROM "deployments"`
...
const insPrefix = "INSERT INTO \"deployments\""
const insReturning = " RETURNING \"id\", \"created_at\", \"updated_at\", \"project_id\", \"name\", \"deleted_at\""
...
func InsertAll(ctx context.Context, ex runtime.Executor, rows []Row) (int64, error) {
	...
	return ex.CopyFrom(ctx, "deployments", copyCols, src)
}
...
var softDeleteSQL = runtime.SpliceSections(`UPDATE "deployments" SET "deleted_at" = now()`, []runtime.Section{
...
var restoreSQL = runtime.SpliceSections(`UPDATE "deployments" SET "deleted_at" = NULL`, []runtime.Section{
