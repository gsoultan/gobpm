...
// source: table idempotency_records
...
type Row struct {
	...
	Body        []byte
	CreatedAt   time.Time
	CompletedAt runtime.Null[time.Time]
}
...
func (q *Query) cursor(col uint32, r Row) {
	...
	case 3:
		...
		q.nums[q.nn] = int64(r.StatusCode)
		q.nn++
	case 6:
...
var (
	RecordKey   = TextCol{0}
	RequestHash = TextCol{1}
	Completed   = BoolCol{2}
	StatusCode  = Int64Col{3}
	Headers     = JSONCol{4}
	Body        = NullBytesCol{5}
	CreatedAt   = TimeCol{6}
	CompletedAt = NullTimeCol{7}
)
...
func (q Query) RecordKeyEq(v string) Query              { return q.Where(RecordKey.Eq(v)) }
func (q Query) RecordKeyNotEq(v string) Query           { return q.Where(RecordKey.NotEq(v)) }
func (q Query) RecordKeyGt(v string) Query              { return q.Where(RecordKey.Gt(v)) }
func (q Query) RecordKeyGte(v string) Query             { return q.Where(RecordKey.Gte(v)) }
func (q Query) RecordKeyLt(v string) Query              { return q.Where(RecordKey.Lt(v)) }
func (q Query) RecordKeyLte(v string) Query             { return q.Where(RecordKey.Lte(v)) }
func (q Query) RecordKeyLike(v string) Query            { return q.Where(RecordKey.Like(v)) }
func (q Query) RecordKeyILike(v string) Query           { return q.Where(RecordKey.ILike(v)) }
func (q Query) RecordKeyIn(v ...string) Query           { return q.Where(RecordKey.In(v...)) }
func (q Query) RecordKeyNotIn(v ...string) Query        { return q.Where(RecordKey.NotIn(v...)) }
func (q Query) RequestHashEq(v string) Query            { return q.Where(RequestHash.Eq(v)) }
func (q Query) RequestHashNotEq(v string) Query         { return q.Where(RequestHash.NotEq(v)) }
func (q Query) RequestHashGt(v string) Query            { return q.Where(RequestHash.Gt(v)) }
func (q Query) RequestHashGte(v string) Query           { return q.Where(RequestHash.Gte(v)) }
func (q Query) RequestHashLt(v string) Query            { return q.Where(RequestHash.Lt(v)) }
func (q Query) RequestHashLte(v string) Query           { return q.Where(RequestHash.Lte(v)) }
func (q Query) RequestHashLike(v string) Query          { return q.Where(RequestHash.Like(v)) }
func (q Query) RequestHashILike(v string) Query         { return q.Where(RequestHash.ILike(v)) }
func (q Query) RequestHashIn(v ...string) Query         { return q.Where(RequestHash.In(v...)) }
func (q Query) RequestHashNotIn(v ...string) Query      { return q.Where(RequestHash.NotIn(v...)) }
func (q Query) CompletedEq(v bool) Query                { return q.Where(Completed.Eq(v)) }
func (q Query) CompletedNotEq(v bool) Query             { return q.Where(Completed.NotEq(v)) }
func (q Query) StatusCodeEq(v int64) Query              { return q.Where(StatusCode.Eq(v)) }
func (q Query) StatusCodeNotEq(v int64) Query           { return q.Where(StatusCode.NotEq(v)) }
func (q Query) StatusCodeGt(v int64) Query              { return q.Where(StatusCode.Gt(v)) }
func (q Query) StatusCodeGte(v int64) Query             { return q.Where(StatusCode.Gte(v)) }
func (q Query) StatusCodeLt(v int64) Query              { return q.Where(StatusCode.Lt(v)) }
func (q Query) StatusCodeLte(v int64) Query             { return q.Where(StatusCode.Lte(v)) }
func (q Query) StatusCodeIn(v ...int64) Query           { return q.Where(StatusCode.In(v...)) }
func (q Query) StatusCodeNotIn(v ...int64) Query        { return q.Where(StatusCode.NotIn(v...)) }
func (q Query) HeadersContains(v runtime.JSON) Query    { return q.Where(Headers.Contains(v)) }
func (q Query) HeadersContainedBy(v runtime.JSON) Query { return q.Where(Headers.ContainedBy(v)) }
func (q Query) HeadersHasAnyKey(v ...string) Query      { return q.Where(Headers.HasAnyKey(v...)) }
func (q Query) HeadersHasAllKeys(v ...string) Query     { return q.Where(Headers.HasAllKeys(v...)) }
func (q Query) BodyIsNull() Query                       { return q.Where(Body.IsNull()) }
func (q Query) BodyIsNotNull() Query                    { return q.Where(Body.IsNotNull()) }
...
func (q Query) CompletedAtEq(v time.Time) Query         { return q.Where(CompletedAt.Eq(v)) }
func (q Query) CompletedAtNotEq(v time.Time) Query      { return q.Where(CompletedAt.NotEq(v)) }
func (q Query) CompletedAtGt(v time.Time) Query         { return q.Where(CompletedAt.Gt(v)) }
func (q Query) CompletedAtGte(v time.Time) Query        { return q.Where(CompletedAt.Gte(v)) }
func (q Query) CompletedAtLt(v time.Time) Query         { return q.Where(CompletedAt.Lt(v)) }
func (q Query) CompletedAtLte(v time.Time) Query        { return q.Where(CompletedAt.Lte(v)) }
func (q Query) CompletedAtIsNull() Query                { return q.Where(CompletedAt.IsNull()) }
func (q Query) CompletedAtIsNotNull() Query             { return q.Where(CompletedAt.IsNotNull()) }

const selectPrefix = `SELECT "record_key", "request_hash", "completed", "status_code", "headers", "body", "created_at", "completed_at" FROM "idempotency_records"`
const countPrefix = `SELECT count(*) FROM "idempotency_records"`
const existsPrefix = `SELECT 1 FROM "idempotency_records"`
...
var orderTable = [nCols][4]string{
	{ // record_key
		"\"record_key\"",
		"\"record_key\" DESC",
		"\"record_key\" ASC NULLS FIRST",
		"\"record_key\" DESC NULLS LAST",
	},
	{ // request_hash
		"\"request_hash\"",
		"\"request_hash\" DESC",
		"\"request_hash\" ASC NULLS FIRST",
		"\"request_hash\" DESC NULLS LAST",
	},
	{ // completed
		"\"completed\"",
		"\"completed\" DESC",
		"\"completed\" ASC NULLS FIRST",
		"\"completed\" DESC NULLS LAST",
	},
	{ // status_code
		"\"status_code\"",
		"\"status_code\" DESC",
		"\"status_code\" ASC NULLS FIRST",
		"\"status_code\" DESC NULLS LAST",
	},
	{ // headers
		"\"headers\"",
		"\"headers\" DESC",
		"\"headers\" ASC NULLS FIRST",
		"\"headers\" DESC NULLS LAST",
	},
	{ // body
		"\"body\"",
		"\"body\" DESC",
...
var fragTable = [8][27]runtime.Frag{
	...
	{ // request_hash
		...
		{A: "\"request_hash\" < $", B: ""},
		{A: "\"request_hash\" <= $", B: ""},
		{A: "\"request_hash\" LIKE $", B: ""},
		{A: "\"request_hash\" ILIKE $", B: ""},
		{},
		{},
		{},
		{},
		{},
		{A: "\"request_hash\" = ANY($", B: ")"},
		{A: "\"request_hash\" <> ALL($", B: ")"},
		{},
		{},
		{},
		{},
	...
	{ // completed_at
		...
		{},
		{},
		{A: "\"completed_at\" IS NULL", B: ""},
		{A: "\"completed_at\" IS NOT NULL", B: ""},
		{},
		{},
	},
}
...
var defaultOrder = [1]runtime.Tok{
	runtime.MakeOrder(runtime.Asc, 0), // record_key
}
...
func scan(rv [][]byte, r *Row, sl *runtime.Slab) error {
	r.RecordKey = sl.Str(rv[0])
	r.RequestHash = sl.Str(rv[1])
	r.Completed = runtime.Bool(rv[2])
	r.StatusCode = runtime.Int8(rv[3])
	r.Headers = runtime.JSON(runtime.JSONB(rv[4], sl))
	r.Body = runtime.Bytes(rv[5])
	r.CreatedAt = runtime.Timestamptz(rv[6])
	r.CompletedAt = runtime.Nullable(rv[7], runtime.Timestamptz)
	return nil
}
...
func (q Query) bindPreds(b *binder) []any {
	v := b.vals[:0]
	var ns, nn, ntm, nbo, njs, nas, nai64 uint8
...
const insertSQL = `INSERT INTO "idempotency_records" ("record_key", "request_hash", "completed", "status_code", "headers", "body", "created_at", "completed_at") VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING "record_key", "request_hash", "completed", "status_code", "headers", "body", "created_at", "completed_at"`

const updatePrefix = `UPDATE "idempotency_records" SET `
const deletePrefix = `DELETE FROM "idempotency_records"`

// Dirty bits. One per updatable column; the set of them is an UPDATE's
// identity, exactly as a token stream is a SELECT's.
const (
	dRequestHash uint64 = 1 << 0
	dCompleted   uint64 = 1 << 1
	dStatusCode  uint64 = 1 << 2
	dHeaders     uint64 = 1 << 3
	dBody        uint64 = 1 << 4
	dCreatedAt   uint64 = 1 << 5
	dCompletedAt uint64 = 1 << 6
)
...
const (
	iRecordKey   uint64 = 1 << 0
	iRequestHash uint64 = 1 << 1
	iCompleted   uint64 = 1 << 2
	iStatusCode  uint64 = 1 << 3
	iHeaders     uint64 = 1 << 4
	iBody        uint64 = 1 << 5
	iCreatedAt   uint64 = 1 << 6
	iCompletedAt uint64 = 1 << 7
)
...
const insPrefix = "INSERT INTO \"idempotency_records\""
const insReturning = " RETURNING \"record_key\", \"request_hash\", \"completed\", \"status_code\", \"headers\", \"body\", \"created_at\", \"completed_at\""
...
func (m *Mut) SetRequestHash(v string) {
	m.row.RequestHash = v
	m.dirty |= dRequestHash
}

func (m *Mut) SetCompleted(v bool) {
	m.row.Completed = v
	m.dirty |= dCompleted
}

func (m *Mut) SetStatusCode(v int64) {
	m.row.StatusCode = v
	m.dirty |= dStatusCode
}

func (m *Mut) SetHeaders(v runtime.JSON) {
	m.row.Headers = v
	m.dirty |= dHeaders
}

func (m *Mut) SetBody(v []byte) {
	m.row.Body = v
	m.dirty |= dBody
}
...
func (m *Mut) SetCompletedAt(v time.Time) {
	m.row.CompletedAt = runtime.Null[time.Time]{V: v, Valid: true}
	m.dirty |= dCompletedAt
}

// SetCompletedAtNull writes SQL NULL. It is a separate method because a
// zero value and an absent value are different facts.
func (m *Mut) SetCompletedAtNull() {
	m.row.CompletedAt = runtime.Null[time.Time]{}
	m.dirty |= dCompletedAt
}
...
func (n *Ins) SetRecordKey(v string) {
	n.row.RecordKey = v
	n.set |= iRecordKey
}

func (n *Ins) SetRequestHash(v string) {
	n.row.RequestHash = v
	n.set |= iRequestHash
}

func (n *Ins) SetCompleted(v bool) {
	n.row.Completed = v
	n.set |= iCompleted
}

func (n *Ins) SetStatusCode(v int64) {
	n.row.StatusCode = v
	n.set |= iStatusCode
}

func (n *Ins) SetHeaders(v runtime.JSON) {
	n.row.Headers = v
	n.set |= iHeaders
}

func (n *Ins) SetBody(v []byte) {
	n.row.Body = v
	n.set |= iBody
}
...
func (n *Ins) SetCompletedAt(v time.Time) {
	n.row.CompletedAt = runtime.Null[time.Time]{V: v, Valid: true}
	n.set |= iCompletedAt
}

// SetCompletedAtNull writes SQL NULL explicitly, which is not the same as
// leaving the column unset and taking its default.
func (n *Ins) SetCompletedAtNull() {
	n.row.CompletedAt = runtime.Null[time.Time]{}
	n.set |= iCompletedAt
}
...
func assignable(i uint8, mask uint64) []string {
	...
	case 0:
		if mask&(1<<1) != 0 {
			set = append(set, "request_hash")
		}
		if mask&(1<<2) != 0 {
			set = append(set, "completed")
		}
		if mask&(1<<3) != 0 {
			set = append(set, "status_code")
		}
		if mask&(1<<4) != 0 {
			set = append(set, "headers")
		}
		if mask&(1<<5) != 0 {
			set = append(set, "body")
		}
...
//	n.OnConflictRecordKey().DoNothing()  // only on that one index
//
...
var assignFor = map[string]string{
	"request_hash": "\"request_hash\" = EXCLUDED.\"request_hash\"",
	"completed":    "\"completed\" = EXCLUDED.\"completed\"",
	"status_code":  "\"status_code\" = EXCLUDED.\"status_code\"",
	"headers":      "\"headers\" = EXCLUDED.\"headers\"",
	"body":         "\"body\" = EXCLUDED.\"body\"",
	"created_at":   "\"created_at\" = EXCLUDED.\"created_at\"",
	"completed_at": "\"completed_at\" = EXCLUDED.\"completed_at\"",
}
...
func (n *Ins) Insert(ctx context.Context, ex runtime.Executor) (Row, error) {
	...
	for i := 0; i < nInsertable; i++ {
		...
		switch i {
		case 0:
			args = append(args, n.row.RecordKey)
		case 1:
			args = append(args, n.row.RequestHash)
		case 2:
			args = append(args, n.row.Completed)
		case 3:
			args = append(args, n.row.StatusCode)
		case 4:
			args = append(args, n.row.Headers)
		case 5:
...
func Insert(ctx context.Context, ex runtime.Executor, r *Row) error {
	args := make([]any, 0, 8)
	args = append(args, r.RecordKey)
	args = append(args, r.RequestHash)
	args = append(args, r.Completed)
	args = append(args, r.StatusCode)
	args = append(args, r.Headers)
	args = append(args, r.Body)
	args = append(args, r.CreatedAt)
	args = append(args, r.CompletedAt.Arg())
...
func (s *rowSource) Values() []any {
	r := &s.rows[s.i-1]
	s.buf[0] = &r.RecordKey
	s.buf[1] = &r.RequestHash
	s.buf[2] = &r.Completed
	s.buf[3] = &r.StatusCode
	s.buf[4] = &r.Headers
	s.buf[5] = &r.Body
	s.buf[6] = &r.CreatedAt
	s.buf[7] = r.CompletedAt.Ptr()
	return s.buf[:]
}
...
func InsertAll(ctx context.Context, ex runtime.Executor, rows []Row) (int64, error) {
	...
	return ex.CopyFrom(ctx, "idempotency_records", copyCols, src)
}
...
func (m *Mut) UpdateOp() (runtime.BatchOp, bool) {
	...
	for i := 0; i < nUpdatable; i++ {
		...
		switch i {
		case 0:
			args = append(args, m.row.RequestHash)
		case 1:
			args = append(args, m.row.Completed)
		case 2:
			args = append(args, m.row.StatusCode)
		case 3:
			args = append(args, m.row.Headers)
		case 4:
	...
	args = append(args, m.row.RecordKey)
	return runtime.BatchOp{SQL: st.SQL, Args: args}, true
}

// DeleteOp is a delete as a queueable statement.
func DeleteOp(recordKey string) runtime.BatchOp {
	return runtime.BatchOp{SQL: deleteSQL, Args: []any{recordKey}}
}
...
const Table = "idempotency_records"
...
func Delete(ctx context.Context, ex runtime.Executor, recordKey string) error {
	n, err := ex.Exec(ctx, deleteSQL, []any{recordKey})
	if err != nil {
		return err
	}
	if n == 0 {
