...
func (q Query) DescriptionEq(v string) Query        { return q.Where(Description.Eq(v)) }
func (q Query) DescriptionNotEq(v string) Query     { return q.Where(Description.NotEq(v)) }
func (q Query) DescriptionGt(v string) Query        { return q.Where(Description.Gt(v)) }
func (q Query) DescriptionGte(v string) Query       { return q.Where(Description.Gte(v)) }
func (q Query) DescriptionLt(v string) Query        { return q.Where(Description.Lt(v)) }
func (q Query) DescriptionLte(v string) Query       { return q.Where(Description.Lte(v)) }
func (q Query) DescriptionLike(v string) Query      { return q.Where(Description.Like(v)) }
func (q Query) DescriptionILike(v string) Query     { return q.Where(Description.ILike(v)) }
func (q Query) DescriptionIn(v ...string) Query     { return q.Where(Description.In(v...)) }
func (q Query) DescriptionNotIn(v ...string) Query  { return q.Where(Description.NotIn(v...)) }
func (q Query) DescriptionIsNull() Query            { return q.Where(Description.IsNull()) }
func (q Query) DescriptionIsNotNull() Query         { return q.Where(Description.IsNotNull()) }
...
func (q Query) AssigneeEq(v string) Query           { return q.Where(Assignee.Eq(v)) }
func (q Query) AssigneeNotEq(v string) Query        { return q.Where(Assignee.NotEq(v)) }
func (q Query) AssigneeGt(v string) Query           { return q.Where(Assignee.Gt(v)) }
func (q Query) AssigneeGte(v string) Query          { return q.Where(Assignee.Gte(v)) }
func (q Query) AssigneeLt(v string) Query           { return q.Where(Assignee.Lt(v)) }
func (q Query) AssigneeLte(v string) Query          { return q.Where(Assignee.Lte(v)) }
func (q Query) AssigneeLike(v string) Query         { return q.Where(Assignee.Like(v)) }
func (q Query) AssigneeILike(v string) Query        { return q.Where(Assignee.ILike(v)) }
func (q Query) AssigneeIn(v ...string) Query        { return q.Where(Assignee.In(v...)) }
func (q Query) AssigneeNotIn(v ...string) Query     { return q.Where(Assignee.NotIn(v...)) }
func (q Query) AssigneeIsNull() Query               { return q.Where(Assignee.IsNull()) }
func (q Query) AssigneeIsNotNull() Query            { return q.Where(Assignee.IsNotNull()) }
func (q Query) CandidateUsersContains(v runtime.JSON) Query {
	return q.Where(CandidateUsers.Contains(v))
}
func (q Query) CandidateUsersContainedBy(v runtime.JSON) Query {
	return q.Where(CandidateUsers.ContainedBy(v))
}
func (q Query) CandidateUsersHasAnyKey(v ...string) Query {
	return q.Where(CandidateUsers.HasAnyKey(v...))
}
func (q Query) CandidateUsersHasAllKeys(v ...string) Query {
	return q.Where(CandidateUsers.HasAllKeys(v...))
}
func (q Query) CandidateGroupsContains(v runtime.JSON) Query {
	return q.Where(CandidateGroups.Contains(v))
}
func (q Query) CandidateGroupsContainedBy(v runtime.JSON) Query {
	return q.Where(CandidateGroups.ContainedBy(v))
}
func (q Query) CandidateGroupsHasAnyKey(v ...string) Query {
	return q.Where(CandidateGroups.HasAnyKey(v...))
}
...
var orderTable = [nCols][4]string{
	...
	{ // assignee
		"\"assignee\"",
		"\"assignee\" DESC",
		"\"assignee\" ASC NULLS FIRST",
		"\"assignee\" DESC NULLS LAST",
	},
	{ // candidate_users
		"\"candidate_users\"",
		"\"candidate_users\" DESC",
		"\"candidate_users\" ASC NULLS FIRST",
		"\"candidate_users\" DESC NULLS LAST",
	},
	{ // candidate_groups
		"\"candidate_groups\"",
		"\"candidate_groups\" DESC",
	...
	{ // form_key
		"\"form_key\"",
		"\"form_key\" DESC",
		"\"form_key\" ASC NULLS FIRST",
		"\"form_key\" DESC NULLS LAST",
	},
	{ // form_definition
		"\"form_definition\"",
		"\"form_definition\" DESC",
		"\"form_definition\" ASC NULLS FIRST",
		"\"form_definition\" DESC NULLS LAST",
	},
	{ // variables
		"\"variables\"",
		"\"variables\" DESC",
...
var fragTable = [19][27]runtime.Frag{
	{ // id
		{}, // opNone
		{A: "\"id\" = $", B: ""},
		{A: "\"id\" <> $", B: ""},
	...
	{ // description
		...
		{A: "\"description\" < $", B: ""},
		{A: "\"description\" <= $", B: ""},
		{A: "\"description\" LIKE $", B: ""},
		{A: "\"description\" ILIKE $", B: ""},
		{},
		{},
		{},
		{},
		...
		{},
		{},
		{A: "\"description\" IS NULL", B: ""},
		{A: "\"description\" IS NOT NULL", B: ""},
		{},
		{},
	},
	{ // type
	...
	{ // assignee
		...
		{},
		{},
		{A: "\"assignee\" IS NULL", B: ""},
		{A: "\"assignee\" IS NOT NULL", B: ""},
		{},
		{},
	},
	{ // candidate_users
	...
	{ // due_date
		...
		{},
		{},
		{A: "\"due_date\" IS NULL", B: ""},
		{A: "\"due_date\" IS NOT NULL", B: ""},
		{},
		{},
	},
	{ // form_key
		...
		{},
		{},
		{A: "\"form_key\" IS NULL", B: ""},
		{A: "\"form_key\" IS NOT NULL", B: ""},
		{},
		{},
	},
	{ // form_definition
		...
		{A: "\"form_definition\" < $", B: ""},
		{A: "\"form_definition\" <= $", B: ""},
		{A: "\"form_definition\" LIKE $", B: ""},
		{A: "\"form_definition\" ILIKE $", B: ""},
		{},
		{},
		{},
		{},
		{},
		{A: "\"form_definition\" = ANY($", B: ")"},
		{A: "\"form_definition\" <> ALL($", B: ")"},
		{},
		{},
		{},
		{},
		...
		{},
		{},
		{A: "\"form_definition\" IS NULL", B: ""},
		{A: "\"form_definition\" IS NOT NULL", B: ""},
		{},
		{},
	},
	{ // variables
...
var setFrags = [nUpdatable]runtime.Frag{
	...
	{A: "\"form_definition\" = $", B: ""},  // form_definition
...
func (m *Mut) SetDescription(v string) {
	m.row.Description = runtime.Null[string]{V: v, Valid: true}
	m.dirty |= dDescription
}

// SetDescriptionNull writes SQL NULL. It is a separate method because a
// zero value and an absent value are different facts.
func (m *Mut) SetDescriptionNull() {
	m.row.Description = runtime.Null[string]{}
	m.dirty |= dDescription
}
...
func (m *Mut) SetAssignee(v string) {
	m.row.Assignee = runtime.Null[string]{V: v, Valid: true}
	m.dirty |= dAssignee
}

// SetAssigneeNull writes SQL NULL. It is a separate method because a
// zero value and an absent value are different facts.
func (m *Mut) SetAssigneeNull() {
	m.row.Assignee = runtime.Null[string]{}
	m.dirty |= dAssignee
}

func (m *Mut) SetCandidateUsers(v runtime.JSON) {
	m.row.CandidateUsers = v
	m.dirty |= dCandidateUsers
}

func (m *Mut) SetCandidateGroups(v runtime.JSON) {
...
func (m *Mut) SetDueDate(v time.Time) {
	m.row.DueDate = runtime.Null[time.Time]{V: v, Valid: true}
	m.dirty |= dDueDate
}

// SetDueDateNull writes SQL NULL. It is a separate method because a
// zero value and an absent value are different facts.
func (m *Mut) SetDueDateNull() {
	m.row.DueDate = runtime.Null[time.Time]{}
	m.dirty |= dDueDate
}

func (m *Mut) SetFormKey(v string) {
	m.row.FormKey = runtime.Null[string]{V: v, Valid: true}
	m.dirty |= dFormKey
}

// SetFormKeyNull writes SQL NULL. It is a separate method because a
// zero value and an absent value are different facts.
func (m *Mut) SetFormKeyNull() {
	m.row.FormKey = runtime.Null[string]{}
	m.dirty |= dFormKey
}

func (m *Mut) SetFormDefinition(v string) {
	m.row.FormDefinition = runtime.Null[string]{V: v, Valid: true}
	m.dirty |= dFormDefinition
}

// SetFormDefinitionNull writes SQL NULL. It is a separate method because a
// zero value and an absent value are different facts.
func (m *Mut) SetFormDefinitionNull() {
	m.row.FormDefinition = runtime.Null[string]{}
	m.dirty |= dFormDefinition
}
...
func (n *Ins) SetDescription(v string) {
	n.row.Description = runtime.Null[string]{V: v, Valid: true}
	n.set |= iDescription
}

// SetDescriptionNull writes SQL NULL explicitly, which is not the same as
// leaving the column unset and taking its default.
func (n *Ins) SetDescriptionNull() {
	n.row.Description = runtime.Null[string]{}
	n.set |= iDescription
}
...
func (n *Ins) SetAssignee(v string) {
	n.row.Assignee = runtime.Null[string]{V: v, Valid: true}
	n.set |= iAssignee
}

// SetAssigneeNull writes SQL NULL explicitly, which is not the same as
// leaving the column unset and taking its default.
func (n *Ins) SetAssigneeNull() {
	n.row.Assignee = runtime.Null[string]{}
	n.set |= iAssignee
}

func (n *Ins) SetCandidateUsers(v runtime.JSON) {
	n.row.CandidateUsers = v
	n.set |= iCandidateUsers
}

func (n *Ins) SetCandidateGroups(v runtime.JSON) {
	n.row.CandidateGroups = v
...
func (n *Ins) SetDueDate(v time.Time) {
	n.row.DueDate = runtime.Null[time.Time]{V: v, Valid: true}
	n.set |= iDueDate
}

// SetDueDateNull writes SQL NULL explicitly, which is not the same as
// leaving the column unset and taking its default.
func (n *Ins) SetDueDateNull() {
	n.row.DueDate = runtime.Null[time.Time]{}
	n.set |= iDueDate
}

func (n *Ins) SetFormKey(v string) {
	n.row.FormKey = runtime.Null[string]{V: v, Valid: true}
	n.set |= iFormKey
}

// SetFormKeyNull writes SQL NULL explicitly, which is not the same as
// leaving the column unset and taking its default.
func (n *Ins) SetFormKeyNull() {
	n.row.FormKey = runtime.Null[string]{}
	n.set |= iFormKey
}

func (n *Ins) SetFormDefinition(v string) {
	n.row.FormDefinition = runtime.Null[string]{V: v, Valid: true}
	n.set |= iFormDefinition
}

// SetFormDefinitionNull writes SQL NULL explicitly, which is not the same as
// leaving the column unset and taking its default.
func (n *Ins) SetFormDefinitionNull() {
	n.row.FormDefinition = runtime.Null[string]{}
	n.set |= iFormDefinition
}
...
var assignFor = map[string]string{
	...
	"form_definition":  "\"form_definition\" = EXCLUDED.\"form_definition\"",
...
func Insert(ctx context.Context, ex runtime.Executor, r *Row) error {
	...
	args = append(args, r.FormDefinition.Arg())
...
func InsertAll(ctx context.Context, ex runtime.Executor, rows []Row) (int64, error) {
	...
	return ex.CopyFrom(ctx, "tasks", copyCols, src)
}
...
var softDeleteSQL = runtime.SpliceSections(`UPDATE "tasks" SET "deleted_at" = now()`, []runtime.Section{
...
var restoreSQL = runtime.SpliceSections(`UPDATE "tasks" SET "deleted_at" = NULL`, []runtime.Section{
