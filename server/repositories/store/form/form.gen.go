...
func (q Query) FieldsContains(v runtime.JSON) Query    { return q.Where(Fields.Contains(v)) }
func (q Query) FieldsContainedBy(v runtime.JSON) Query { return q.Where(Fields.ContainedBy(v)) }
func (q Query) FieldsHasAnyKey(v ...string) Query      { return q.Where(Fields.HasAnyKey(v...)) }
func (q Query) FieldsHasAllKeys(v ...string) Query     { return q.Where(Fields.HasAllKeys(v...)) }
...
const selectPrefix = `SELECT "id", "created_at", "updated_at", "project_id", "key", "name", "fields", "deleted_at" FROM "forms"`
const countPrefix = `SELECT count(*) FROM "forms"`
const existsPrefix = `SELECT 1 FROM "forms"`
...
var orderTable = [nCols][4]string{
	...
	{ // fields
		"\"fields\"",
		"\"fields\" DESC",
		"\"fields\" ASC NULLS FIRST",
		"\"fields\" DESC NULLS LAST",
	},
	{ // deleted_at
		"\"deleted_at\"",
		"\"deleted_at\" DESC",
...
func scan(rv [][]byte, r *Row, sl *runtime.Slab) error {
	...
	r.Key = sl.Str(rv[4])
	r.Name = sl.Str(rv[5])
	r.Fields = runtime.JSON(runtime.JSONB(rv[6], sl))
...
const insertSQL = `INSERT INTO "forms" ("id", "created_at", "updated_at", "project_id", "key", "name", "fields", "deleted_at") VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING "id", "created_at", "updated_at", "project_id", "key", "name", "fields", "deleted_at"`

const updatePrefix = `UPDATE "forms" SET `
const deletePrefix = `DELETE FROM "forms"`
...
const insPrefix = "INSERT INTO \"forms\""
const insReturning = " RETURNING \"id\", \"created_at\", \"updated_at\", \"project_id\", \"key\", \"name\", \"fields\", \"deleted_at\""
...
func (m *Mut) SetFields(v runtime.JSON) {
	m.row.Fields = v
	m.dirty |= dFields
}
...
func (n *Ins) SetFields(v runtime.JSON) {
	n.row.Fields = v
	n.set |= iFields
}
...
func InsertAll(ctx context.Context, ex runtime.Executor, rows []Row) (int64, error) {
	...
	return ex.CopyFrom(ctx, "forms", copyCols, src)
}
...
var softDeleteSQL = runtime.SpliceSections(`UPDATE "forms" SET "deleted_at" = now()`, []runtime.Section{
...
var restoreSQL = runtime.SpliceSections(`UPDATE "forms" SET "deleted_at" = NULL`, []runtime.Section{
