...
var (
	...
	Type       = TextCol{5}
	NodeID     = NullTextCol{6}
	NodeName   = NullTextCol{7}
	Message    = TextCol{8}
...
func (q Query) NodeIDIsNull() Query                  { return q.Where(NodeID.IsNull()) }
func (q Query) NodeIDIsNotNull() Query               { return q.Where(NodeID.IsNotNull()) }
func (q Query) NodeNameEq(v string) Query            { return q.Where(NodeName.Eq(v)) }
func (q Query) NodeNameNotEq(v string) Query         { return q.Where(NodeName.NotEq(v)) }
func (q Query) NodeNameGt(v string) Query            { return q.Where(NodeName.Gt(v)) }
func (q Query) NodeNameGte(v string) Query           { return q.Where(NodeName.Gte(v)) }
func (q Query) NodeNameLt(v string) Query            { return q.Where(NodeName.Lt(v)) }
func (q Query) NodeNameLte(v string) Query           { return q.Where(NodeName.Lte(v)) }
func (q Query) NodeNameLike(v string) Query          { return q.Where(NodeName.Like(v)) }
func (q Query) NodeNameILike(v string) Query         { return q.Where(NodeName.ILike(v)) }
func (q Query) NodeNameIn(v ...string) Query         { return q.Where(NodeName.In(v...)) }
func (q Query) NodeNameNotIn(v ...string) Query      { return q.Where(NodeName.NotIn(v...)) }
func (q Query) NodeNameIsNull() Query                { return q.Where(NodeName.IsNull()) }
func (q Query) NodeNameIsNotNull() Query             { return q.Where(NodeName.IsNotNull()) }
...
func (q Query) NarrativeEq(v string) Query           { return q.Where(Narrative.Eq(v)) }
func (q Query) NarrativeNotEq(v string) Query        { return q.Where(Narrative.NotEq(v)) }
func (q Query) NarrativeGt(v string) Query           { return q.Where(Narrative.Gt(v)) }
func (q Query) NarrativeGte(v string) Query          { return q.Where(Narrative.Gte(v)) }
func (q Query) NarrativeLt(v string) Query           { return q.Where(Narrative.Lt(v)) }
func (q Query) NarrativeLte(v string) Query          { return q.Where(Narrative.Lte(v)) }
func (q Query) NarrativeLike(v string) Query         { return q.Where(Narrative.Like(v)) }
func (q Query) NarrativeILike(v string) Query        { return q.Where(Narrative.ILike(v)) }
func (q Query) NarrativeIn(v ...string) Query        { return q.Where(Narrative.In(v...)) }
func (q Query) NarrativeNotIn(v ...string) Query     { return q.Where(Narrative.NotIn(v...)) }
func (q Query) NarrativeIsNull() Query               { return q.Where(Narrative.IsNull()) }
func (q Query) NarrativeIsNotNull() Query            { return q.Where(Narrative.IsNotNull()) }
func (q Query) DataContains(v runtime.JSON) Query    { return q.Where(Data.Contains(v)) }
...
var orderTable = [nCols][4]string{
	...
	{ // node_name
		"\"node_name\"",
		"\"node_name\" DESC",
		"\"node_name\" ASC NULLS FIRST",
		"\"node_name\" DESC NULLS LAST",
	},
	{ // message
		"\"message\"",
		"\"message\" DESC",
	...
	{ // narrative
		"\"narrative\"",
		"\"narrative\" DESC",
		"\"narrative\" ASC NULLS FIRST",
		"\"narrative\" DESC NULLS LAST",
	},
	{ // data
		"\"data\"",
		"\"data\" DESC",
...
var fragTable = [12][27]runtime.Frag{
	...
	{ // node_name
		...
		{},
		{},
		{A: "\"node_name\" IS NULL", B: ""},
		{A: "\"node_name\" IS NOT NULL", B: ""},
		{},
		{},
	},
	{ // message
	...
	{ // narrative
		...
		{},
		{},
		{A: "\"narrative\" IS NULL", B: ""},
		{A: "\"narrative\" IS NOT NULL", B: ""},
		{},
		{},
	},
	{ // data
...
func (m *Mut) SetNodeID(v string) {
	m.row.NodeID = runtime.Null[string]{V: v, Valid: true}
	m.dirty |= dNodeID
}

// SetNodeIDNull writes SQL NULL. It is a separate method because a
// zero value and an absent value are different facts.
func (m *Mut) SetNodeIDNull() {
	m.row.NodeID = runtime.Null[string]{}
	m.dirty |= dNodeID
}

func (m *Mut) SetNodeName(v string) {
	m.row.NodeName = runtime.Null[string]{V: v, Valid: true}
	m.dirty |= dNodeName
}

// SetNodeNameNull writes SQL NULL. It is a separate method because a
// zero value and an absent value are different facts.
func (m *Mut) SetNodeNameNull() {
	m.row.NodeName = runtime.Null[string]{}
	m.dirty |= dNodeName
}
...
func (m *Mut) SetNarrative(v string) {
	m.row.Narrative = runtime.Null[string]{V: v, Valid: true}
	m.dirty |= dNarrative
}

// SetNarrativeNull writes SQL NULL. It is a separate method because a
// zero value and an absent value are different facts.
func (m *Mut) SetNarrativeNull() {
	m.row.Narrative = runtime.Null[string]{}
	m.dirty |= dNarrative
}
...
func (n *Ins) SetNodeID(v string) {
	n.row.NodeID = runtime.Null[string]{V: v, Valid: true}
	n.set |= iNodeID
}

// SetNodeIDNull writes SQL NULL explicitly, which is not the same as
// leaving the column unset and taking its default.
func (n *Ins) SetNodeIDNull() {
	n.row.NodeID = runtime.Null[string]{}
	n.set |= iNodeID
}

func (n *Ins) SetNodeName(v string) {
	n.row.NodeName = runtime.Null[string]{V: v, Valid: true}
	n.set |= iNodeName
}

// SetNodeNameNull writes SQL NULL explicitly, which is not the same as
// leaving the column unset and taking its default.
func (n *Ins) SetNodeNameNull() {
	n.row.NodeName = runtime.Null[string]{}
	n.set |= iNodeName
}
...
func (n *Ins) SetNarrative(v string) {
	n.row.Narrative = runtime.Null[string]{V: v, Valid: true}
	n.set |= iNarrative
}

// SetNarrativeNull writes SQL NULL explicitly, which is not the same as
// leaving the column unset and taking its default.
func (n *Ins) SetNarrativeNull() {
	n.row.Narrative = runtime.Null[string]{}
	n.set |= iNarrative
}

func (n *Ins) SetData(v runtime.JSON) {
	n.row.Data = v
	n.set |= iData
}
...
func assignable(i uint8, mask uint64) []string {
	...
	case 0:
		...
		if mask&(1<<7) != 0 {
			set = append(set, "node_name")
		}
		if mask&(1<<8) != 0 {
			set = append(set, "message")
		}
		if mask&(1<<9) != 0 {
			set = append(set, "narrative")
		}
		if mask&(1<<10) != 0 {
			set = append(set, "data")
		}
...
var assignFor = map[string]string{
	...
	"node_name":   "\"node_name\" = EXCLUDED.\"node_name\"",
...
func (n *Ins) Insert(ctx context.Context, ex runtime.Executor) (Row, error) {
	...
	for i := 0; i < nInsertable; i++ {
		...
		case 6:
			args = append(args, n.row.NodeID.Arg())
		case 7:
			args = append(args, n.row.NodeName.Arg())
		case 8:
			args = append(args, n.row.Message)
		case 9:
			args = append(args, n.row.Narrative.Arg())
		case 10:
...
func Insert(ctx context.Context, ex runtime.Executor, r *Row) error {
	...
	args = append(args, r.NodeID.Arg())
	args = append(args, r.NodeName.Arg())
...
func (s *rowSource) Values() []any {
	...
	s.buf[5] = &r.Type
	s.buf[6] = r.NodeID.Ptr()
	s.buf[7] = r.NodeName.Ptr()
	s.buf[8] = &r.Message
...
func (m *Mut) UpdateOp() (runtime.BatchOp, bool) {
	...
	for i := 0; i < nUpdatable; i++ {
		...
		case 4:
			args = append(args, m.row.NodeID.Arg())
		case 5:
			args = append(args, m.row.NodeName.Arg())
		case 6:
			args = append(args, m.row.Message)
		case 7:
			args = append(args, m.row.Narrative.Arg())
		case 8:
...
var softDeleteSQL = runtime.SpliceSections(`UPDATE "audit_logs" SET "deleted_at" = now()`, []runtime.Section{
...
var restoreSQL = runtime.SpliceSections(`UPDATE "audit_logs" SET "deleted_at" = NULL`, []runtime.Section{
