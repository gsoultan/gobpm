...
func HasMembers() Pred   { return Pred{col: 7, op: opExists} }
func HasNoMembers() Pred { return Pred{col: 7, op: opNotExists} }
...
const selectPrefix = `SELECT "id", "created_at", "updated_at", "project_id", "name", "description", "deleted_at" FROM "workflow_groups"`
const countPrefix = `SELECT count(*) FROM "workflow_groups"`
const existsPrefix = `SELECT 1 FROM "workflow_groups"`
...
var fragTable = [8][27]runtime.Frag{
	...
	{ // relation Members (pseudo-column)
		{}, // opNone
		{},
		{},
		{},
		...
		{},
		{},
		{A: "EXISTS (SELECT 1 FROM \"workflow_group_memberships\" AS \"_storm_e\" WHERE \"_storm_e\".\"workflow_group_id\" = \"workflow_groups\".\"id\")"},
		{A: "NOT EXISTS (SELECT 1 FROM \"workflow_group_memberships\" AS \"_storm_e\" WHERE \"_storm_e\".\"workflow_group_id\" = \"workflow_groups\".\"id\")"},
	},
}
...
const insertSQL = `INSERT INTO "workflow_groups" ("id", "created_at", "updated_at", "project_id", "name", "description", "deleted_at") VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING "id", "created_at", "updated_at", "project_id", "name", "description", "deleted_at"`

const updatePrefix = `UPDATE "workflow_groups" SET `
const deletePrefix = `DELETE FROM "workflow_groups"`
...
const insPrefix = "INSERT INTO \"workflow_groups\""
const insReturning = " RETURNING \"id\", \"created_at\", \"updated_at\", \"project_id\", \"name\", \"description\", \"deleted_at\""
...
// OnConflictProjectIDName upserts on the unique index over (project_id, name).
//
// The row that already exists keeps every column this insert did
// not assign. Follow with DoNothing() to leave it untouched
// entirely.
...
func InsertAll(ctx context.Context, ex runtime.Executor, rows []Row) (int64, error) {
	...
	return ex.CopyFrom(ctx, "workflow_groups", copyCols, src)
}
...
var softDeleteSQL = runtime.SpliceSections(`UPDATE "workflow_groups" SET "deleted_at" = now()`, []runtime.Section{
...
var restoreSQL = runtime.SpliceSections(`UPDATE "workflow_groups" SET "deleted_at" = NULL`, []runtime.Section{
