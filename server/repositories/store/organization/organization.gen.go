...
func HasProjects() Pred   { return Pred{col: 6, op: opExists} }
func HasNoProjects() Pred { return Pred{col: 6, op: opNotExists} }
...
const selectPrefix = `SELECT "id", "created_at", "updated_at", "name", "description", "deleted_at" FROM "organizations"`
const countPrefix = `SELECT count(*) FROM "organizations"`
const existsPrefix = `SELECT 1 FROM "organizations"`
...
var fragTable = [7][27]runtime.Frag{
	...
	{ // relation Projects (pseudo-column)
		{}, // opNone
		{},
		{},
		{},
		...
		{},
		{},
		{A: "EXISTS (SELECT 1 FROM \"projects\" AS \"_storm_e\" WHERE \"_storm_e\".\"organization_id\" = \"organizations\".\"id\" AND \"_storm_e\".\"deleted_at\" IS NULL)"},
		{A: "NOT EXISTS (SELECT 1 FROM \"projects\" AS \"_storm_e\" WHERE \"_storm_e\".\"organization_id\" = \"organizations\".\"id\" AND \"_storm_e\".\"deleted_at\" IS NULL)"},
	},
}
...
func scan(rv [][]byte, r *Row, sl *runtime.Slab) error {
	...
	r.DeletedAt = runtime.Nullable(rv[5], runtime.Timestamptz)
	return nil
}
...
const insertSQL = `INSERT INTO "organizations" ("id", "created_at", "updated_at", "name", "description", "deleted_at") VALUES ($1, $2, $3, $4, $5, $6) RETURNING "id", "created_at", "updated_at", "name", "description", "deleted_at"`

const updatePrefix = `UPDATE "organizations" SET `
const deletePrefix = `DELETE FROM "organizations"`
...
const insPrefix = "INSERT INTO \"organizations\""
const insReturning = " RETURNING \"id\", \"created_at\", \"updated_at\", \"name\", \"description\", \"deleted_at\""
...
func InsertAll(ctx context.Context, ex runtime.Executor, rows []Row) (int64, error) {
	...
	return ex.CopyFrom(ctx, "organizations", copyCols, src)
}
...
var softDeleteSQL = runtime.SpliceSections(`UPDATE "organizations" SET "deleted_at" = now()`, []runtime.Section{
...
var restoreSQL = runtime.SpliceSections(`UPDATE "organizations" SET "deleted_at" = NULL`, []runtime.Section{
