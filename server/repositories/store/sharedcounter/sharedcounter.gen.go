...
var (
	Scope       = TextCol{0}
	CounterKey  = TextCol{1}
	Replica     = TextCol{2}
	WindowStart = TimeCol{3}
	Count       = Int64Col{4}
	UpdatedAt   = TimeCol{5}
)
...
func (q Query) ScopeEq(v string) Query             { return q.Where(Scope.Eq(v)) }
func (q Query) ScopeNotEq(v string) Query          { return q.Where(Scope.NotEq(v)) }
func (q Query) ScopeGt(v string) Query             { return q.Where(Scope.Gt(v)) }
func (q Query) ScopeGte(v string) Query            { return q.Where(Scope.Gte(v)) }
func (q Query) ScopeLt(v string) Query             { return q.Where(Scope.Lt(v)) }
func (q Query) ScopeLte(v string) Query            { return q.Where(Scope.Lte(v)) }
func (q Query) ScopeLike(v string) Query           { return q.Where(Scope.Like(v)) }
func (q Query) ScopeILike(v string) Query          { return q.Where(Scope.ILike(v)) }
func (q Query) ScopeIn(v ...string) Query          { return q.Where(Scope.In(v...)) }
func (q Query) ScopeNotIn(v ...string) Query       { return q.Where(Scope.NotIn(v...)) }
func (q Query) CounterKeyEq(v string) Query        { return q.Where(CounterKey.Eq(v)) }
func (q Query) CounterKeyNotEq(v string) Query     { return q.Where(CounterKey.NotEq(v)) }
func (q Query) CounterKeyGt(v string) Query        { return q.Where(CounterKey.Gt(v)) }
func (q Query) CounterKeyGte(v string) Query       { return q.Where(CounterKey.Gte(v)) }
func (q Query) CounterKeyLt(v string) Query        { return q.Where(CounterKey.Lt(v)) }
func (q Query) CounterKeyLte(v string) Query       { return q.Where(CounterKey.Lte(v)) }
func (q Query) CounterKeyLike(v string) Query      { return q.Where(CounterKey.Like(v)) }
func (q Query) CounterKeyILike(v string) Query     { return q.Where(CounterKey.ILike(v)) }
func (q Query) CounterKeyIn(v ...string) Query     { return q.Where(CounterKey.In(v...)) }
func (q Query) CounterKeyNotIn(v ...string) Query  { return q.Where(CounterKey.NotIn(v...)) }
func (q Query) ReplicaEq(v string) Query           { return q.Where(Replica.Eq(v)) }
func (q Query) ReplicaNotEq(v string) Query        { return q.Where(Replica.NotEq(v)) }
func (q Query) ReplicaGt(v string) Query           { return q.Where(Replica.Gt(v)) }
func (q Query) ReplicaGte(v string) Query          { return q.Where(Replica.Gte(v)) }
func (q Query) ReplicaLt(v string) Query           { return q.Where(Replica.Lt(v)) }
func (q Query) ReplicaLte(v string) Query          { return q.Where(Replica.Lte(v)) }
func (q Query) ReplicaLike(v string) Query         { return q.Where(Replica.Like(v)) }
func (q Query) ReplicaILike(v string) Query        { return q.Where(Replica.ILike(v)) }
func (q Query) ReplicaIn(v ...string) Query        { return q.Where(Replica.In(v...)) }
func (q Query) ReplicaNotIn(v ...string) Query     { return q.Where(Replica.NotIn(v...)) }
func (q Query) WindowStartEq(v time.Time) Query    { return q.Where(WindowStart.Eq(v)) }
func (q Query) WindowStartNotEq(v time.Time) Query { return q.Where(WindowStart.NotEq(v)) }
func (q Query) WindowStartGt(v time.Time) Query    { return q.Where(WindowStart.Gt(v)) }
func (q Query) WindowStartGte(v time.Time) Query   { return q.Where(WindowStart.Gte(v)) }
func (q Query) WindowStartLt(v time.Time) Query    { return q.Where(WindowStart.Lt(v)) }
func (q Query) WindowStartLte(v time.Time) Query   { return q.Where(WindowStart.Lte(v)) }
func (q Query) CountEq(v int64) Query              { return q.Where(Count.Eq(v)) }
func (q Query) CountNotEq(v int64) Query           { return q.Where(Count.NotEq(v)) }
func (q Query) CountGt(v int64) Query              { return q.Where(Count.Gt(v)) }
func (q Query) CountGte(v int64) Query             { return q.Where(Count.Gte(v)) }
func (q Query) CountLt(v int64) Query              { return q.Where(Count.Lt(v)) }
func (q Query) CountLte(v int64) Query             { return q.Where(Count.Lte(v)) }
func (q Query) CountIn(v ...int64) Query           { return q.Where(Count.In(v...)) }
func (q Query) CountNotIn(v ...int64) Query        { return q.Where(Count.NotIn(v...)) }
...
const selectPrefix = `SELECT "scope", "counter_key", "replica", "window_start", "count", "updated_at" FROM "shared_counters"`
const countPrefix = `SELECT count(*) FROM "shared_counters"`
const existsPrefix = `SELECT 1 FROM "shared_counters"`
...
var orderTable = [nCols][4]string{
	{ // scope
		"\"scope\"",
		"\"scope\" DESC",
		"\"scope\" ASC NULLS FIRST",
		"\"scope\" DESC NULLS LAST",
	},
	{ // counter_key
		"\"counter_key\"",
		"\"counter_key\" DESC",
		"\"counter_key\" ASC NULLS FIRST",
		"\"counter_key\" DESC NULLS LAST",
	},
	{ // replica
		"\"replica\"",
		"\"replica\" DESC",
		"\"replica\" ASC NULLS FIRST",
		"\"replica\" DESC NULLS LAST",
	},
	{ // window_start
		"\"window_start\"",
		"\"window_start\" DESC",
		"\"window_start\" ASC NULLS FIRST",
		"\"window_start\" DESC NULLS LAST",
	},
	{ // count
		"\"count\"",
		"\"count\" DESC",
		"\"count\" ASC NULLS FIRST",
...
var fragTable = [6][27]runtime.Frag{
	...
	{ // counter_key
		...
		{A: "\"counter_key\" < $", B: ""},
		{A: "\"counter_key\" <= $", B: ""},
		{A: "\"counter_key\" LIKE $", B: ""},
		{A: "\"counter_key\" ILIKE $", B: ""},
		{},
		{},
		{},
		{},
...
var defaultOrder = [4]runtime.Tok{
	runtime.MakeOrder(runtime.Asc, 0), // scope
	runtime.MakeOrder(runtime.Asc, 1), // counter_key
	runtime.MakeOrder(runtime.Asc, 2), // replica
	runtime.MakeOrder(runtime.Asc, 3), // window_start
}
...
func scan(rv [][]byte, r *Row, sl *runtime.Slab) error {
	r.Scope = sl.Str(rv[0])
	r.CounterKey = sl.Str(rv[1])
	r.Replica = sl.Str(rv[2])
	r.WindowStart = runtime.Timestamptz(rv[3])
	r.Count = runtime.Int8(rv[4])
...
const insertSQL = `INSERT INTO "shared_counters" ("scope", "counter_key", "replica", "window_start", "count", "updated_at") VALUES ($1, $2, $3, $4, $5, $6) RETURNING "scope", "counter_key", "replica", "window_start", "count", "updated_at"`

const updatePrefix = `UPDATE "shared_counters" SET `
const deletePrefix = `DELETE FROM "shared_counters"`

// Dirty bits. One per updatable column; the set of them is an UPDATE's
// identity, exactly as a token stream is a SELECT's.
const (
	dCount     uint64 = 1 << 0
	dUpdatedAt uint64 = 1 << 1
)
...
var pkFrags = [4]runtime.Frag{
	{A: "\"scope\" = $", B: ""},        // scope
	{A: "\"counter_key\" = $", B: ""},  // counter_key
	{A: "\"replica\" = $", B: ""},      // replica
...
const (
	iScope       uint64 = 1 << 0
	iCounterKey  uint64 = 1 << 1
	iReplica     uint64 = 1 << 2
	iWindowStart uint64 = 1 << 3
	iCount       uint64 = 1 << 4
	iUpdatedAt   uint64 = 1 << 5
)
...
const insPrefix = "INSERT INTO \"shared_counters\""
const insReturning = " RETURNING \"scope\", \"counter_key\", \"replica\", \"window_start\", \"count\", \"updated_at\""
...
func (n *Ins) SetScope(v string) {
	n.row.Scope = v
	n.set |= iScope
}

func (n *Ins) SetCounterKey(v string) {
	n.row.CounterKey = v
	n.set |= iCounterKey
}

func (n *Ins) SetReplica(v string) {
	n.row.Replica = v
	n.set |= iReplica
}

func (n *Ins) SetWindowStart(v time.Time) {
	n.row.WindowStart = v
	n.set |= iWindowStart
}

func (n *Ins) SetCount(v int64) {
	n.row.Count = v
	n.set |= iCount
}
...
var conflictSpecs = []string{
	" ON CONFLICT (\"scope\", \"counter_key\", \"replica\", \"window_start\")",
}
...
// OnConflictScopeCounterKeyReplicaWindowStart upserts on the unique index over (scope, counter_key, replica, window_start).
//
// The row that already exists keeps every column this insert did
// not assign. Follow with DoNothing() to leave it untouched
// entirely.
func (n *Ins) OnConflictScopeCounterKeyReplicaWindowStart() *Ins {
	n.conflict = 2
	return n
}
...
//	n.OnConflictScopeCounterKeyReplicaWindowStart().DoNothing()  // only on that one index
//
...
func (n *Ins) Insert(ctx context.Context, ex runtime.Executor) (Row, error) {
	...
	for i := 0; i < nInsertable; i++ {
		...
		switch i {
		case 0:
			args = append(args, n.row.Scope)
		case 1:
			args = append(args, n.row.CounterKey)
		case 2:
			args = append(args, n.row.Replica)
		case 3:
			args = append(args, n.row.WindowStart)
		case 4:
			args = append(args, n.row.Count)
		case 5:
...
func Insert(ctx context.Context, ex runtime.Executor, r *Row) error {
	args := make([]any, 0, 6)
	args = append(args, r.Scope)
	args = append(args, r.CounterKey)
	args = append(args, r.Replica)
	args = append(args, r.WindowStart)
	args = append(args, r.Count)
...
func (s *rowSource) Values() []any {
	r := &s.rows[s.i-1]
	s.buf[0] = &r.Scope
	s.buf[1] = &r.CounterKey
	s.buf[2] = &r.Replica
	s.buf[3] = &r.WindowStart
	s.buf[4] = &r.Count
	s.buf[5] = &r.UpdatedAt
	return s.buf[:]
}
...
func InsertAll(ctx context.Context, ex runtime.Executor, rows []Row) (int64, error) {
	...
	return ex.CopyFrom(ctx, "shared_counters", copyCols, src)
}
...
func (m *Mut) UpdateOp() (runtime.BatchOp, bool) {
	...
	for i := 0; i < nUpdatable; i++ {
		...
		switch i {
		case 0:
			args = append(args, m.row.Count)
		case 1:
			args = append(args, m.row.UpdatedAt)
		}
	}
	args = append(args, m.row.Scope)
	args = append(args, m.row.CounterKey)
	args = append(args, m.row.Replica)
	args = append(args, m.row.WindowStart)
	return runtime.BatchOp{SQL: st.SQL, Args: args}, true
}

// DeleteOp is a delete as a queueable statement.
func DeleteOp(scope string, counterKey string, replica string, windowStart time.Time) runtime.BatchOp {
	return runtime.BatchOp{SQL: deleteSQL, Args: []any{scope, counterKey, replica, windowStart}}
}
...
func Delete(ctx context.Context, ex runtime.Executor, scope string, counterKey string, replica string, windowStart time.Time) error {
	n, err := ex.Exec(ctx, deleteSQL, []any{scope, counterKey, replica, windowStart})
	if err != nil {
		return err
	}
	if n == 0 {
