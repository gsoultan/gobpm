...
func InsertAll(ctx context.Context, ex runtime.Executor, rows []Row) (int64, error) {
	...
	return ex.CopyFrom(ctx, "broadcast_events", copyCols, src)
}
...
func DeleteOp(iD int64) runtime.BatchOp {
...
func Delete(ctx context.Context, ex runtime.Executor, iD int64) error {
