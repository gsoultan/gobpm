...
const selectPrefix = `SELECT "id", "created_at", "updated_at", "organization_id", "name", "description", "roles", "deleted_at" FROM "groups"`
const countPrefix = `SELECT count(*) FROM "groups"`
const existsPrefix = `SELECT 1 FROM "groups"`
...
func scan(rv [][]byte, r *Row, sl *runtime.Slab) error {
	...
	r.Name = sl.Str(rv[4])
	r.Description = sl.Str(rv[5])
	r.Roles = runtime.JSON(runtime.JSONB(rv[6], sl))
...
const insertSQL = `INSERT INTO "groups" ("id", "created_at", "updated_at", "organization_id", "name", "description", "roles", "deleted_at") VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING "id", "created_at", "updated_at", "organization_id", "name", "description", "roles", "deleted_at"`

const updatePrefix = `UPDATE "groups" SET `
const deletePrefix = `DELETE FROM "groups"`
...
const insPrefix = "INSERT INTO \"groups\""
const insReturning = " RETURNING \"id\", \"created_at\", \"updated_at\", \"organization_id\", \"name\", \"description\", \"roles\", \"deleted_at\""
...
func (n *Ins) Insert(ctx context.Context, ex runtime.Executor) (Row, error) {
	...
	for i := 0; i < nInsertable; i++ {
		...
		case 5:
			args = append(args, n.row.Description)
		case 6:
...
func InsertAll(ctx context.Context, ex runtime.Executor, rows []Row) (int64, error) {
	...
	return ex.CopyFrom(ctx, "groups", copyCols, src)
}
...
func (m *Mut) UpdateOp() (runtime.BatchOp, bool) {
	...
	for i := 0; i < nUpdatable; i++ {
		...
		case 3:
			args = append(args, m.row.Description)
		case 4:
...
var softDeleteSQL = runtime.SpliceSections(`UPDATE "groups" SET "deleted_at" = now()`, []runtime.Section{
...
var restoreSQL = runtime.SpliceSections(`UPDATE "groups" SET "deleted_at" = NULL`, []runtime.Section{
