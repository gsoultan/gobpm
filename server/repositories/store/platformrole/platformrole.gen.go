...
var (
	...
	UpdatedAt   = TimeCol{2}
	Name        = TextCol{3}
	Description = NullTextCol{4}
	Permissions = JSONCol{5}
	BuiltIn     = BoolCol{6}
...
func (q Query) PermissionsContains(v runtime.JSON) Query { return q.Where(Permissions.Contains(v)) }
func (q Query) PermissionsContainedBy(v runtime.JSON) Query {
	return q.Where(Permissions.ContainedBy(v))
}
func (q Query) PermissionsHasAnyKey(v ...string) Query  { return q.Where(Permissions.HasAnyKey(v...)) }
func (q Query) PermissionsHasAllKeys(v ...string) Query { return q.Where(Permissions.HasAllKeys(v...)) }
func (q Query) BuiltInEq(v bool) Query                  { return q.Where(BuiltIn.Eq(v)) }
func (q Query) BuiltInNotEq(v bool) Query               { return q.Where(BuiltIn.NotEq(v)) }
...
const selectPrefix = `SELECT "id", "created_at", "updated_at", "name", "description", "permissions", "built_in", "deleted_at" FROM "platform_roles"`
const countPrefix = `SELECT count(*) FROM "platform_roles"`
const existsPrefix = `SELECT 1 FROM "platform_roles"`
...
var orderTable = [nCols][4]string{
	...
	{ // permissions
		"\"permissions\"",
		"\"permissions\" DESC",
		"\"permissions\" ASC NULLS FIRST",
		"\"permissions\" DESC NULLS LAST",
	},
	{ // built_in
		"\"built_in\"",
		"\"built_in\" DESC",
		"\"built_in\" ASC NULLS FIRST",
		"\"built_in\" DESC NULLS LAST",
	},
	{ // deleted_at
		"\"deleted_at\"",
		"\"deleted_at\" DESC",
...
func scan(rv [][]byte, r *Row, sl *runtime.Slab) error {
	...
	r.Name = sl.Str(rv[3])
	r.Description = runtime.NullText(rv[4], sl)
	r.Permissions = runtime.JSON(runtime.JSONB(rv[5], sl))
	r.BuiltIn = runtime.Bool(rv[6])
...
const insertSQL = `INSERT INTO "platform_roles" ("id", "created_at", "updated_at", "name", "description", "permissions", "built_in", "deleted_at") VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING "id", "created_at", "updated_at", "name", "description", "permissions", "built_in", "deleted_at"`

const updatePrefix = `UPDATE "platform_roles" SET `
const deletePrefix = `DELETE FROM "platform_roles"`
...
const (
	...
	dName        uint64 = 1 << 1
	dDescription uint64 = 1 << 2
	dPermissions uint64 = 1 << 3
	dBuiltIn     uint64 = 1 << 4
...
const (
	...
	iName        uint64 = 1 << 3
	iDescription uint64 = 1 << 4
	iPermissions uint64 = 1 << 5
	iBuiltIn     uint64 = 1 << 6
...
const insPrefix = "INSERT INTO \"platform_roles\""
const insReturning = " RETURNING \"id\", \"created_at\", \"updated_at\", \"name\", \"description\", \"permissions\", \"built_in\", \"deleted_at\""
...
func (m *Mut) SetPermissions(v runtime.JSON) {
	m.row.Permissions = v
	m.dirty |= dPermissions
}

func (m *Mut) SetBuiltIn(v bool) {
	m.row.BuiltIn = v
	m.dirty |= dBuiltIn
}
...
func (n *Ins) SetPermissions(v runtime.JSON) {
	n.row.Permissions = v
	n.set |= iPermissions
}

func (n *Ins) SetBuiltIn(v bool) {
	n.row.BuiltIn = v
	n.set |= iBuiltIn
}
...
var assignFor = map[string]string{
	...
	"permissions": "\"permissions\" = EXCLUDED.\"permissions\"",
	"built_in":    "\"built_in\" = EXCLUDED.\"built_in\"",
...
func (n *Ins) Insert(ctx context.Context, ex runtime.Executor) (Row, error) {
	...
	for i := 0; i < nInsertable; i++ {
		...
		case 5:
			args = append(args, n.row.Permissions)
		case 6:
			args = append(args, n.row.BuiltIn)
		case 7:
...
func Insert(ctx context.Context, ex runtime.Executor, r *Row) error {
	...
	args = append(args, r.Permissions)
	args = append(args, r.BuiltIn)
...
func (s *rowSource) Values() []any {
	...
	s.buf[2] = &r.UpdatedAt
	s.buf[3] = &r.Name
	s.buf[4] = r.Description.Ptr()
	s.buf[5] = &r.Permissions
	s.buf[6] = &r.BuiltIn
...
func InsertAll(ctx context.Context, ex runtime.Executor, rows []Row) (int64, error) {
	...
	return ex.CopyFrom(ctx, "platform_roles", copyCols, src)
}
...
func (m *Mut) UpdateOp() (runtime.BatchOp, bool) {
	...
	for i := 0; i < nUpdatable; i++ {
		...
		case 3:
			args = append(args, m.row.Permissions)
		case 4:
			args = append(args, m.row.BuiltIn)
		case 5:
...
var softDeleteSQL = runtime.SpliceSections(`UPDATE "platform_roles" SET "deleted_at" = now()`, []runtime.Section{
...
var restoreSQL = runtime.SpliceSections(`UPDATE "platform_roles" SET "deleted_at" = NULL`, []runtime.Section{
