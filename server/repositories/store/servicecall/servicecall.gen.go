...
func (q Query) IdempotencyKeyEq(v string) Query          { return q.Where(IdempotencyKey.Eq(v)) }
func (q Query) IdempotencyKeyNotEq(v string) Query       { return q.Where(IdempotencyKey.NotEq(v)) }
func (q Query) IdempotencyKeyGt(v string) Query          { return q.Where(IdempotencyKey.Gt(v)) }
func (q Query) IdempotencyKeyGte(v string) Query         { return q.Where(IdempotencyKey.Gte(v)) }
func (q Query) IdempotencyKeyLt(v string) Query          { return q.Where(IdempotencyKey.Lt(v)) }
func (q Query) IdempotencyKeyLte(v string) Query         { return q.Where(IdempotencyKey.Lte(v)) }
func (q Query) IdempotencyKeyLike(v string) Query        { return q.Where(IdempotencyKey.Like(v)) }
func (q Query) IdempotencyKeyILike(v string) Query       { return q.Where(IdempotencyKey.ILike(v)) }
func (q Query) IdempotencyKeyIn(v ...string) Query       { return q.Where(IdempotencyKey.In(v...)) }
func (q Query) IdempotencyKeyNotIn(v ...string) Query    { return q.Where(IdempotencyKey.NotIn(v...)) }
...
func (q Query) AttemptsEq(v int64) Query                 { return q.Where(Attempts.Eq(v)) }
func (q Query) AttemptsNotEq(v int64) Query              { return q.Where(Attempts.NotEq(v)) }
func (q Query) AttemptsGt(v int64) Query                 { return q.Where(Attempts.Gt(v)) }
func (q Query) AttemptsGte(v int64) Query                { return q.Where(Attempts.Gte(v)) }
func (q Query) AttemptsLt(v int64) Query                 { return q.Where(Attempts.Lt(v)) }
func (q Query) AttemptsLte(v int64) Query                { return q.Where(Attempts.Lte(v)) }
func (q Query) AttemptsIn(v ...int64) Query              { return q.Where(Attempts.In(v...)) }
func (q Query) AttemptsNotIn(v ...int64) Query           { return q.Where(Attempts.NotIn(v...)) }
func (q Query) ResponseContains(v runtime.JSON) Query    { return q.Where(Response.Contains(v)) }
func (q Query) ResponseContainedBy(v runtime.JSON) Query { return q.Where(Response.ContainedBy(v)) }
func (q Query) ResponseHasAnyKey(v ...string) Query      { return q.Where(Response.HasAnyKey(v...)) }
func (q Query) ResponseHasAllKeys(v ...string) Query     { return q.Where(Response.HasAllKeys(v...)) }
...
var orderTable = [nCols][4]string{
	...
	{ // idempotency_key
		...
		"\"idempotency_key\" ASC NULLS FIRST",
		"\"idempotency_key\" DESC NULLS LAST",
	},
	{ // status
		"\"status\"",
		"\"status\" DESC",
	...
	{ // attempts
		...
		"\"attempts\" DESC NULLS LAST",
	},
	{ // response
		"\"response\"",
		"\"response\" DESC",
		"\"response\" ASC NULLS FIRST",
		"\"response\" DESC NULLS LAST",
	},
	{ // completed_at
		"\"completed_at\"",
		"\"completed_at\" DESC",
...
var fragTable = [13][27]runtime.Frag{
	...
	{ // idempotency_key
		...
		{A: "\"idempotency_key\" < $", B: ""},
		{A: "\"idempotency_key\" <= $", B: ""},
		{A: "\"idempotency_key\" LIKE $", B: ""},
		{A: "\"idempotency_key\" ILIKE $", B: ""},
		{},
		{},
		{},
		{},
		{},
		{A: "\"idempotency_key\" = ANY($", B: ")"},
		{A: "\"idempotency_key\" <> ALL($", B: ")"},
		{},
		{},
		{},
		{},
...
func (m *Mut) SetIdempotencyKey(v string) {
	m.row.IdempotencyKey = v
	m.dirty |= dIdempotencyKey
}
...
func (m *Mut) SetAttempts(v int64) {
	m.row.Attempts = v
	m.dirty |= dAttempts
}

func (m *Mut) SetResponse(v runtime.JSON) {
	m.row.Response = v
	m.dirty |= dResponse
}
...
func (n *Ins) SetIdempotencyKey(v string) {
	n.row.IdempotencyKey = v
	n.set |= iIdempotencyKey
}
...
func (n *Ins) SetAttempts(v int64) {
	n.row.Attempts = v
	n.set |= iAttempts
}

func (n *Ins) SetResponse(v runtime.JSON) {
	n.row.Response = v
	n.set |= iResponse
}
...
func Insert(ctx context.Context, ex runtime.Executor, r *Row) error {
	...
	args = append(args, r.Attempts)
	args = append(args, r.Response)
...
func InsertAll(ctx context.Context, ex runtime.Executor, rows []Row) (int64, error) {
	...
	return ex.CopyFrom(ctx, "service_calls", copyCols, src)
}
...
var softDeleteSQL = runtime.SpliceSections(`UPDATE "service_calls" SET "deleted_at" = now()`, []runtime.Section{
...
var restoreSQL = runtime.SpliceSections(`UPDATE "service_calls" SET "deleted_at" = NULL`, []runtime.Section{
