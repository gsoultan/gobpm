...
// source: table connector_instances
...
const selectPrefix = `SELECT "id", "created_at", "updated_at", "project_id", "connector_id", "name", "config", "deleted_at" FROM "connector_instances"`
const countPrefix = `SELECT count(*) FROM "connector_instances"`
const existsPrefix = `SELECT 1 FROM "connector_instances"`
...
var orderTable = [nCols][4]string{
	...
	{ // connector_id
		"\"connector_id\"",
		"\"connector_id\" DESC",
		"\"connector_id\" ASC NULLS FIRST",
		"\"connector_id\" DESC NULLS LAST",
	},
	{ // name
		"\"name\"",
		"\"name\" DESC",
...
var fragTable = [8][27]runtime.Frag{
	...
	{ // connector_id
		...
		{},
		{},
		{A: "\"connector_id\" = ANY($", B: ")"},
		{A: "\"connector_id\" <> ALL($", B: ")"},
		{},
		{},
		{},
		{},
...
const insertSQL = `INSERT INTO "connector_instances" ("id", "created_at", "updated_at", "project_id", "connector_id", "name", "config", "deleted_at") VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING "id", "created_at", "updated_at", "project_id", "connector_id", "name", "config", "deleted_at"`

const updatePrefix = `UPDATE "connector_instances" SET `
const deletePrefix = `DELETE FROM "connector_instances"`
...
const insPrefix = "INSERT INTO \"connector_instances\""
const insReturning = " RETURNING \"id\", \"created_at\", \"updated_at\", \"project_id\", \"connector_id\", \"name\", \"config\", \"deleted_at\""
...
func (m *Mut) SetConnectorID(v [16]byte) {
	m.row.ConnectorID = v
	m.dirty |= dConnectorID
}
...
func (n *Ins) SetConnectorID(v [16]byte) {
	n.row.ConnectorID = v
	n.set |= iConnectorID
}
...
var assignFor = map[string]string{
	...
	"connector_id": "\"connector_id\" = EXCLUDED.\"connector_id\"",
...
func (n *Ins) Insert(ctx context.Context, ex runtime.Executor) (Row, error) {
	...
	for i := 0; i < nInsertable; i++ {
		...
		case 4:
			args = append(args, n.row.ConnectorID)
		case 5:
...
func Insert(ctx context.Context, ex runtime.Executor, r *Row) error {
	...
	args = append(args, r.ConnectorID)
...
func InsertAll(ctx context.Context, ex runtime.Executor, rows []Row) (int64, error) {
	...
	return ex.CopyFrom(ctx, "connector_instances", copyCols, src)
}
...
func (m *Mut) UpdateOp() (runtime.BatchOp, bool) {
	...
	for i := 0; i < nUpdatable; i++ {
		...
		case 2:
			args = append(args, m.row.ConnectorID)
		case 3:
...
const Table = "connector_instances"
...
var softDeleteSQL = runtime.SpliceSections(`UPDATE "connector_instances" SET "deleted_at" = now()`, []runtime.Section{
...
var restoreSQL = runtime.SpliceSections(`UPDATE "connector_instances" SET "deleted_at" = NULL`, []runtime.Section{
